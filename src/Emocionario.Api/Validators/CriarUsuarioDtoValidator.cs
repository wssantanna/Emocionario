...
/// Garante que todos os campos obrigatórios estejam preenchidos e válidos.
/// </summary>
public class CriarUsuarioDtoValidator : AbstractValidator<CriarUsuarioDto>
{
    public CriarUsuarioDtoValidator()
    {
        ...
        RuleFor(x => x.Sobrenome)
            ...
            .Length(3, 50)
            .WithMessage("O sobrenome deve ter entre 3 e 50 caracteres.")
            .Matches("^[a-zA-ZÀ-ÿ\\s]+$")
        ...
        RuleFor(x => x.Email)
            ...
            .EmailAddress()
            .WithMessage("O email deve ser um endereço válido.")
            .MaximumLength(255)
